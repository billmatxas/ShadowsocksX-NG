...
let LAUNCH_AGENT_CONF_SSLOCAL_NAME = "com.hu.qiuyuzhou.shadowsocksX-NG.local.plist"
let LAUNCH_AGENT_CONF_PRIVOXY_NAME = "com.hu.qiuyuzhou.shadowsocksX-NG.http.plist"
let LAUNCH_AGENT_CONF_KCPTUN_NAME = "com.hu.qiuyuzhou.shadowsocksX-NG.kcptun.plist"
...
func generateSSLocalLauchAgentPlist() -> Bool {
    ...
    let dict: NSMutableDictionary = [
        "Label": "com.hu.qiuyuzhou.shadowsocksX-NG.local",
...
func generatePrivoxyLauchAgentPlist() -> Bool {
    ...
    // For a complete listing of the keys, see the launchd.plist manual page.
    let dict: NSMutableDictionary = [
        "Label": "com.hu.qiuyuzhou.shadowsocksX-NG.http",
        "WorkingDirectory": NSHomeDirectory() + APP_SUPPORT_DIR,
        "StandardOutPath": logFilePath,
        "StandardErrorPath": logFilePath,
        "ProgramArguments": arguments
...
func generateKcptunLauchAgentPlist() -> Bool {
    ...
    // For a complete listing of the keys, see the launchd.plist manual page.
    let dict: NSMutableDictionary = [
        "Label": "com.hu.qiuyuzhou.shadowsocksX-NG.kcptun",
        "WorkingDirectory": NSHomeDirectory() + APP_SUPPORT_DIR,
        "StandardOutPath": logFilePath,
        "StandardErrorPath": logFilePath,
        "ProgramArguments": arguments,
